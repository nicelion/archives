...
<nav id="nav" class="fixed inset-x-0 top-0 flex flex-row justify-between z-10 text-white bg-transparent">
    ...
    <div class="p-4">
        ...
        <a href="#" id='logo' class='text-white flex space-x-4 items-center'>
            <img src="/logo.png" alt="" class="h-10 md:h-14">
            <div class="">
                <h1 class="font-bold text-2xl">Nice Lion Technologies</h1>
                <p class="text-center border-t-[1px] pt-1">Physical Media Archiving</p>
            </div>
        </a>
    </div>

    <!-- Nav Items Working on Tablet & Bigger Sceen -->
    <div class="p-4 hidden md:flex flex-row justify-between ">
        ...
        <a href="#whyus" class="mx-4 text-lg border-b-2 border-transparent hover:border-b-2 hover:border-indigo-300 transition duration-500">Services</a>
        <a href="#showcase" class="mx-4 text-lg border-b-2 border-transparent hover:border-b-2 hover:border-indigo-300 transition duration-500">Pricing</a>
    </div>
