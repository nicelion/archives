...
<nav id="nav" class="fixed inset-x-0 top-0 flex flex-row justify-between z-10 text-white items-center bg-black">
    ...
    <div class="p-4 hidden md:flex flex-row justify-between ">
        ...
        <a href="#services" class="mx-4 text-lg border-b-2 border-transparent hover:border-b-2 hover:border-indigo-300 transition duration-500">Services</a>
        <a href="#pricing" class="mx-4 text-lg border-b-2 border-transparent hover:border-b-2 hover:border-indigo-300 transition duration-500">Pricing</a>
        <a href="#our-work" class="mx-4 text-lg border-b-2 border-transparent hover:border-b-2 hover:border-indigo-300 transition duration-500">Our Work</a>
    </div>
      ...
      <div class="mt-16">
        ...
        <div class="mt-16 sm:flex sm:items-center sm:justify-between">
          <div class="flex justify-center text-teal-600 sm:justify-start">
            <a href="#" id='logo' class=' flex space-x-4 items-center text-gray-500 font-logo'>
                <img src="/logo.png" alt="" class="h-10 md:h-14">
                <div class="">
